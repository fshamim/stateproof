# StateProof `0.8.0-alpha01` Announcement Draft

StateProof `0.8.0-alpha01` is now available as a Maven Central prerelease.
...
`0.8.0-alpha01` is a prerelease intended to validate integration and workflow stability before a 1.0 launch.
